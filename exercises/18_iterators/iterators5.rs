...
fn count_iterator(map: &HashMap<String, Progress>, value: Progress) -> usize {
    ...
    // ! Use the 'filter' method to obtain only those with the correct value, and then
    // ! the 'count' method to return an usize
...
fn count_collection_iterator(collection: &[HashMap<String, Progress>], value: Progress) -> usize {
    ...
    //               { "variables2": Complete, … }, … ]
    // ! Use 'flat_map' instead of 'map' when the output produces an iterator but not values directly,
    // ! and this way you avoid having another layer of abstraction
